...
def route_payload(task_id: str, request: str, kind: str, model: str, include_design: bool, require_approval: bool, workspace: str) -> dict[str, Any]:
    ...
    return {
        ...
        "phases": phases,
        "routing": {"design": include_design, "approval": require_approval},
